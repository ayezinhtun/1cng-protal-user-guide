...
WorkPress installation is based on Ubuntu 24.04 OS and it consist of the following software packages:
...
### <span style={{ color: '#003366' }}>Following environment variables are provide:</span>
...
For producation deployments, it is strongly recommended to:
